...
public class PathTester {
	...
	public static void main(String[] args) throws Exception {
		...
		//Vector2d flag = new Vector2d(-15.70766,-0.0012);
		//Vector2d start = new Vector2d(-3.14288,0.002504);
		
		//Vector2d aPoint = new Vector2d(-10,25.25);
		...
		GridTraversal travel = new GridTraversal(course);
